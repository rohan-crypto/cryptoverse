...
// millify converts big numbers into readable numbers 
...
// do object destructuring so that we dont need to write Typography.Title many times
...
const HomePage = () => {
  ...
  // isFetching is true if data is undefined
  ...
  return (
    <>
      ...
      {/* simplified will show first 10 instead of showing first 100  */}
